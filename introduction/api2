...
Draft of API V2 commands for work with EGAAS. To work with REST API V2 you need to compile a server from the **gorm_arch** branch. There's no graphic interface for API V2 when viewed in a browser.
